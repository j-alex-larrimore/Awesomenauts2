...
(function () {
    ...
    /** @scope me.ObjectContainer.prototype */
    {
        ...
        init : function (x, y, width, height) {
            ...
            console.log("Fall? " + this.fallThrough);
        },
...
(function () {
    ...
    /** @scope me.ObjectEntity.prototype */ {
        ...
        init : function (x, y, settings) {
            ...
            this.fallThrough = false;
            console.log("Object fall? " + this.fallThrough);
            /**
        ...
        updateMovement : function () {
            ...
            if (this.collidable) {
                ...
                if (collision.y) {
                    ...
                    if (collision.y > 0) {
                        if(prop.isPlatform){
                            console.log("Platform " + this.fallThrough);
                        }
                        if (prop.isSolid ||
                            (prop.isPlatform && !this.fallThrough && (this._bounds.bottom - 1 <= tile.pos.y)) ||
